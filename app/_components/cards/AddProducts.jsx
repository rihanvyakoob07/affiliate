...
function AddProducts({text,price,imageUrl}) {
    ...
    return (
        ...
        onMouseLeave={() => setHover(false)}  style={{ backgroundImage: `url(${imageUrl})` }} className={`h-[236.8px] bg-cover  bg-no-repeat bg-center relative rounded-t-[7px]    `}  >
                ...
                <div onClick={()=>setclicked(true)} className="absolute transition duration-300 ease-in text-[rgba(75,85,99,1)] h-[13.66px] text-[16px] top-2 right-2">
